...
const GalleryPage = () => {
  ...
  const images = [
    "/images/center/gallery1.jpg",
    "/images/center/gallery2.jpg",
    "/images/center/gallery3.jpg",
    "/images/center/gallery4.jpg",
    "/images/center/gallery5.jpg",
    "/images/center/gallery6.jpg",
    "/images/center/gallery7.jpg",
    "/images/center/gallery8.jpg",
    "/images/center/gallery9.jpg",
    "/images/center/gallery10.jpg",
    "/images/center/gallery11.jpg",
    "/images/center/gallery12.jpg",
  ];
      ...
      <section className="relative h-[40vh] min-h-[300px]">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col justify-center h-full">
            ...
            >
              Discover the elegance and beauty of The Center Court
            </motion.p>
          </div>
        </div>
      </section>
