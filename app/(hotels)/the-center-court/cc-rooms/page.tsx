...
const rooms: Room[] = [
  {
    ...
    description:
      "Perfect for families, featuring modern amenities and comfortable spaces with stunning pool views.",
    image: "/images/center/room1.jpg",
    amenities: [
...
const RoomsPage: React.FC = () => {
  ...
  const locationId = "center-rooms-id";
  return (
