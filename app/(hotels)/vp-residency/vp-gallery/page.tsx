...
const GalleryPage = () => {
  ...
  const images = [
    "/images/vp/gallery1.jpg",
    "/images/vp/gallery2.jpg",
    "/images/vp/gallery3.jpg",
    "/images/vp/gallery4.jpg",
    "/images/vp/gallery5.jpg",
    "/images/vp/gallery6.jpg",
    "/images/vp/hero1.jpg",
    "/images/vp/hero2.jpg",
    "/images/vp/hero3.jpg",
  ];
      ...
      <section className="relative h-[40vh] min-h-[300px]">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col justify-center h-full">
            ...
            >
              Take a visual journey through our elegant spaces and premium
              amenities
            </motion.p>
          </div>
        </div>
