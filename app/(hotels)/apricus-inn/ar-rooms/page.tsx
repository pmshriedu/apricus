...
const rooms: Room[] = [
  {
    ...
    image: "/images/apricus/room1.jpg",
    amenities: [
      ...
      <section className="relative h-[50vh] lg:h-[60vh]">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col justify-center h-full">
            ...
            >
              Experience a world where elegance meets comfort, creating magical
              moments that last a lifetime. Welcome to your sanctuary of
              serenity.
            </motion.p>
          </div>
        </div>
