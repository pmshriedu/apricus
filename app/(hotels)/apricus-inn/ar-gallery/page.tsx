...
const GalleryPage = () => {
  ...
  const images = [
    ...
    "/images/apricus/gallery4.jpg",
    "/images/apricus/dine1.jpg",
    "/images/apricus/dine3.jpg",
    "/images/apricus/bar1.jpg",
    "/images/apricus/bar2.jpg",
    "/images/apricus/craft-kitchen.jpg",
    "/images/apricus/room1.jpg",
    "/images/apricus/room2.jpg",
    "/images/apricus/room3.jpg",
    "/images/apricus/room6.jpg",
    "/images/apricus/room7.jpg",
  ];
      ...
      <section className="relative h-[40vh] min-h-[300px]">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col justify-center h-full">
            ...
            >
              Discover the elegance and beauty of Apricus Inn Riverside
            </motion.p>
          </div>
        </div>
      </section>
