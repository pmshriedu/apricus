...
const navigationItems = [
  { title: "Home", href: "/the-center-court", icon: Home },
  { title: "Rooms", href: "/the-center-court/cc-rooms", icon: Bed },
  { title: "Dine", href: "/the-center-court/cc-dine", icon: Utensils },
  { title: "Events", href: "/the-center-court/cc-event", icon: Calendar },
  { title: "Gallery", href: "/the-center-court/cc-gallery", icon: Image },
        ...
        <TooltipProvider>
          <Tooltip open={showTooltip}>
            ...
            <TooltipContent side="right" className="bg-primary text-white">
              <p>Click to open Center Court menu</p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
