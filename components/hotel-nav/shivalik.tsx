...
import { Menu, X, Home, Image, PhoneCall, Bed } from "lucide-react";
...
const navigationItems = [
  { title: "Home", href: "/shivalik-hills-mussoorie", icon: Home },
  { title: "Rooms", href: "/shivalik-hills-mussoorie/sh-rooms", icon: Bed },
  {
    title: "Gallery",
    href: "/shivalik-hills-mussoorie/sh-gallery",
    icon: Image,
  },
        ...
        <TooltipProvider>
          <Tooltip open={showTooltip}>
            ...
            <TooltipContent side="right" className="bg-primary text-white">
              <p>Click to open Shivalik Hills menu</p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
