...
const navigationItems = [
  { title: "Home", href: "/bliss-ganga", icon: Home },
  { title: "Rooms", href: "/bliss-ganga/bg-rooms", icon: Bed },
  { title: "Dine", href: "/bliss-ganga/bg-dine", icon: Utensils },
  { title: "Events", href: "/bliss-ganga/bg-events", icon: Calendar },
  { title: "Gallery", href: "/bliss-ganga/bg-gallery", icon: Image },
        ...
        <TooltipProvider>
          <Tooltip open={showTooltip}>
            ...
            <TooltipContent side="right" className="bg-primary text-white">
              <p>Click to open Bliss Ganga menu</p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
