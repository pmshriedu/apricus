...
const navigationItems = [
  { title: "Home", href: "/vp-residency", icon: Home },
  { title: "Rooms", href: "/vp-residency/vp-rooms", icon: Bed },
  { title: "Gallery", href: "/vp-residency/vp-gallery", icon: Image },
        ...
        <TooltipProvider>
          <Tooltip open={showTooltip}>
            ...
            <TooltipContent side="right" className="bg-primary text-white">
              <p>Click to open VP Residency menu</p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
