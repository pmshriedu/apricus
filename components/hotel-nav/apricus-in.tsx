...
import { Menu, X, Home, Utensils, Image, PhoneCall, Bed } from "lucide-react";
...
const navigationItems = [
  { title: "Home", href: "/apricus-inn", icon: Home },
  { title: "Rooms", href: "/apricus-inn/ar-rooms", icon: Bed },
  { title: "Dine", href: "/apricus-inn/ar-dine", icon: Utensils },
  { title: "Gallery", href: "/apricus-inn/ar-gallery", icon: Image },
        ...
        <TooltipProvider>
          <Tooltip open={showTooltip}>
            ...
            <TooltipContent side="right" className="bg-primary text-white">
              <p>Click to open Apricus Inn menu</p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
